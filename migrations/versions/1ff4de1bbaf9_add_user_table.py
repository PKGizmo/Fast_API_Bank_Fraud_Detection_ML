...
def upgrade() -> None:
    ...
    op.create_table(
        "user",
        sa.Column(
            "username", sqlmodel.sql.sqltypes.AutoString(length=12), nullable=True
        ),
        sa.Column(
        ...
        sa.Column(
            "account_status",
            sa.Enum(
                "ACTIVE", "INACTIVE", "LOCKED", "PENDING", name="accountstatusschema"
            ),
            nullable=False,
        ),
        sa.Column(
        ...
        sa.Column(
            "otp_expiry_time", postgresql.TIMESTAMP(timezone=True), nullable=True
        ),
        sa.Column(
            "created_at",
