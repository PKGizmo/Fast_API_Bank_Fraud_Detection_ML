...
Revision ID: 1acd89a9255b
Revises: 1ff4de1bbaf9
Create Date: 2025-07-24 10:59:57.322287
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "title",
            sa.Enum("Mr", "Mrs", "Miss", name="salutationschema"),
            nullable=False,
        ),
        sa.Column(
            "gender", sa.Enum("Male", "Female", name="genderschema"), nullable=False
        ),
