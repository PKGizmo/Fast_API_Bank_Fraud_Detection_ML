...
Revision ID: 3e6630d1967d
Revises: cff3a93792be
Create Date: 2025-07-29 09:11:27.119282
...
revision: str = '3e6630d1967d'
down_revision: Union[str, None] = 'cff3a93792be'
...
def upgrade() -> None:
    ...
    sa.Column('transaction_status', sa.Enum('Pending', 'Completed', 'Failed', 'Reversed', 'Cancelled', name='transactionstatusenum'), nullable=False),
