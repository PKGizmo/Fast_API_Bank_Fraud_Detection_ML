...
class SecurityQuestionsSchema(str, Enum):
    ...
    # classmethod is bound to the class, not the instance
    # method can be called from class, no need for the instance of the class
    # cls argument - reference to the class itself
    # the class is the second argument - SecurityQuestionsSchema
    @classmethod
